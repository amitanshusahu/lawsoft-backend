 ...
 */
async function resolveLawyerUserId(idOrProfileId) {
    ...
    if (lawyerProfile)
        return lawyerProfile.userId;
    // Not found
    return null;
}
export async function isAvailable(lawyerId, scheduledAt, durationMins = 30) {
...
export async function getAvailableSlots(lawyerId, targetDate, // Accept Date or ISO string like "2025-04-05"
options = {}) {
    const { durationMins = 30, intervalMins = 30, workHours = { start: '06:00', end: '19:00' }, excludePastSlots = true, bufferMins = 0, lunchBreak, } = options;
